...
const Blog = () => {
  ...
  const handleSubmit = (e) =>{
    ...
    axios.get(`https://portfolio-38ir.onrender.com/blog/bytag`,{params:{tag:tags,title:"dsaasa", disp:"dakdhak"}}).then(res=>setSearchedBlogs(res.data)).catch(err=>console.log(err))
  }
