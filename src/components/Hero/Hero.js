...
const Hero = () => (
  ...
  <div class="container mx-auto flex px-5 md:py-24 md:flex-row flex-col-reverse items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col  md:text-left mb-16 md:mb-0 items-center text-center">
      <div>
      <h1 class="title-font tracking-wider sm:text-4xl text-3xl mb-4 font-medium text-gray-900 ">Tanuj Bhatt: Web Developer & Blockchain Enthusiast</h1>
      <p class="mb-8 leading-relaxed"> Tanuj Bhatt is a skilled web developer and blockchain enthusiast with a passion for innovative technology. With extensive experience in designing and developing websites and blockchain applications.</p>
      </div>

        <div className='mb-4 flex items-center justify-center '>
      <h3 className='border-r-2 border-black px-1'>
       Stack    
   ...
   `} for="search">E-mail</label>
      ...
      <p class="text-sm mt-2 text-gray-500 mb-8 w-full">Subscribe to keep updated</p>
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
      <img className="object-cover object-center rounded-xl bg-blend-overlay" alt="hero" src="https://firebasestorage.googleapis.com/v0/b/portfolio-e0b16.appspot.com/o/ta.gif?alt=media&token=38d41db3-ad30-4dbd-a851-b42b45e288ec"/>
    </div>
  </div>
</section>
